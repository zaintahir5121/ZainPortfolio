...
projects = [
    ...
    ('Predictive Analytics Engine',
     'Sales forecasting and demand prediction with ML-driven insights',
     'Azure ML, Data Factory, Power BI'),
    ('Face Recognition Login',
     'Passwordless authentication system using facial recognition and liveness detection',
     'Python, AI/ML, .NET'),
    ('AI Based Compliance Review Platform',
     'Automated compliance document analysis using LLMs; flags regulatory gaps, generates audit reports, and tracks policy adherence across enterprise systems',
     'Azure OpenAI, RAG, LLMs, .NET Core, Angular'),
    ('AI Based Spot Report Generator',
     'Intelligent report generation system that synthesizes operational data into structured spot reports using LLMs, reducing manual effort by 80%',
     'Azure OpenAI, LLMs, .NET Core, Cosmos DB'),
    ('Document Chat Using AI',
     'RAG-powered chat interface allowing users to converse with large document repositories; supports multi-format ingestion and semantic search',
     'RAG, Azure AI Search, Azure OpenAI, .NET Core, Angular'),
    ('Agentic AI – Internal Ecosystem Chatbot',
     'Multi-agent AI system with autonomous task planning, tool orchestration, and workflow automation for internal enterprise products',
     'Agentic AI, Copilot Studio, Azure OpenAI, .NET Core, Microservices'),
    ('AI Based Performance Optimization',
     'ML-driven platform that continuously monitors application metrics, auto-detects bottlenecks, and recommends or applies performance improvements',
     'Azure ML, Application Insights, .NET Core, Power BI'),
    ('AI Sales & Lead Generator',
     'End-to-end AI sales pipeline: prospect scoring, personalized outreach generation, lead qualification, and CRM integration via intelligent agents',
     'Azure OpenAI, LLMs, CRM APIs, .NET Core, Angular'),
]
