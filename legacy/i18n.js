...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'nav.ach': 'Awards',
      'ac.tag': 'Recognition',
      'ac.h2': 'Milestones &amp; <span class="grad-text">Recognition</span>',
      'ac.desc': 'Work that shipped, teams that built it, and the moments worth keeping.',
      'ac.first': 'World first',
      'ac.ft': 'The first SaaS-based 834 clearing house',
      'ac.fd': 'EDI 834 enrolment had always run through on-premise clearing houses. We took it to SaaS \u2014 multi-tenant, HIPAA-aligned, and able to onboard a payer without shipping anyone a server.',
      'ac.watch': 'Watch the presentation',
      'ac.qt': 'This was where I stopped being the person writing the code and started being the person answering \u201cwhy this way?\u201d \u2014 architecture standards, impact assessments, HIPAA-aligned design decisions across a healthcare platform. The technical part I could learn. The harder shift was realising my job had become making other engineers effective rather than being the most effective engineer in the room.',
      'ac.qc': 'On leading the platform team at MTBC (CareCloud), 2016\u20132018',
      'ac.g1': 'Best Innovation Team Award', 'ac.g2': 'MTBC (CareCloud), Islamabad',
      'ac.g3': 'DHL CIO &amp; Tech Leads', 'ac.g4': 'US Leadership Summit',
      'ac.g5': 'Security Training', 'ac.g6': 'Excellence Award',
      'ac.cv': 'Full CV &amp; media on LinkedIn',

      'nav.value': 'Approach',
      'vl.tag': 'What I Actually Do',
      'vl.h2': 'From <span class="grad-text">AI Chaos</span> to a Governed Platform',
      'vl.desc': 'Sixty seconds on who I am, the problem I keep being hired to fix, and a calculator you can drive yourself.',
      'vl.vcap': '60-second introduction',
      'vl.pt': 'The problem',
      'vl.p1': 'Every team wires its own model calls, with its own keys and its own prompts.',
      'vl.p2': 'Nobody can say what AI actually costs until the invoice lands.',
      'vl.p3': 'When Legal asks why the model said something, there is no answer.',
      'vl.p4': 'Swapping model providers means refactoring every service at once.',
      'vl.st': 'What I build instead',
      'vl.s1': 'One gateway every AI call passes through, adoptable in under a day per team.',
      'vl.s2': 'Spend capped and reported per team, visible before the invoice.',
      'vl.s3': 'Every prompt, retrieval and answer traced and replayable for audit.',
      'vl.s4': 'Changing provider becomes a configuration change, not a rewrite.',
      'vl.ctag': 'Live demo', 'vl.ch': 'What would governance save you?',
      'vl.cd': 'Move the sliders. The figures recalculate as you drag.',
      'vl.cq': 'Queries per day', 'vl.ct': 'Average tokens per query', 'vl.cteam': 'Teams calling models',
      'vl.cbefore': 'Ungoverned', 'vl.cafter': 'Through the gateway',
      'vl.cmo': 'per month', 'vl.csave': 'saved',
      'vl.cnote': 'Illustrative only, using published list prices. Savings come from routing simple queries to smaller models, caching repeats and trimming prompt bloat \u2014 the three levers a gateway makes possible.',
    ...
    de: {
      ...
      'nav.impact': 'Wirkung',
      'nav.ach': 'Auszeichnungen',
      'ac.tag': 'Anerkennung',
      'ac.h2': 'Meilensteine &amp; <span class="grad-text">Auszeichnungen</span>',
      'ac.desc': 'Systeme, die live gingen, Teams, die sie gebaut haben, und die Momente, die bleiben.',
      'ac.first': 'Weltweit erstmalig',
      'ac.ft': 'Das erste SaaS-basierte 834-Clearinghaus',
      'ac.fd': 'EDI-834-Anmeldungen liefen bis dahin immer \u00fcber lokale Clearingh\u00e4user. Wir haben das in die SaaS-Welt geholt \u2014 mandantenf\u00e4hig, HIPAA-konform und in der Lage, einen Kostentr\u00e4ger anzubinden, ohne irgendwem einen Server zu schicken.',
      'ac.watch': 'Pr\u00e4sentation ansehen',
      'ac.qt': 'Hier h\u00f6rte ich auf, derjenige zu sein, der den Code schreibt, und wurde derjenige, der \u201ewarum so?\u201c beantwortet \u2014 Architekturstandards, Auswirkungsanalysen, HIPAA-konforme Entwurfsentscheidungen \u00fcber eine Gesundheitsplattform hinweg. Das Technische konnte ich lernen. Der schwerere Schritt war die Einsicht, dass meine Aufgabe nun darin bestand, andere Entwickler wirksam zu machen, statt selbst der wirksamste im Raum zu sein.',
      'ac.qc': '\u00dcber die Leitung des Plattformteams bei MTBC (CareCloud), 2016\u20132018',
      'ac.g1': 'Best Innovation Team Award', 'ac.g2': 'MTBC (CareCloud), Islamabad',
      'ac.g3': 'DHL-CIO &amp; Tech Leads', 'ac.g4': 'US-Leadership-Summit',
      'ac.g5': 'Sicherheitsschulung', 'ac.g6': 'Auszeichnung f\u00fcr Exzellenz',
      'ac.cv': 'Vollst\u00e4ndiger Lebenslauf auf LinkedIn',

      'nav.value': 'Ansatz',
      'vl.tag': 'Was ich wirklich tue',
      'vl.h2': 'Vom <span class="grad-text">KI-Wildwuchs</span> zur kontrollierten Plattform',
      'vl.desc': 'Sechzig Sekunden dar\u00fcber, wer ich bin, welches Problem ich immer wieder l\u00f6sen soll \u2014 und ein Rechner, den Sie selbst bedienen k\u00f6nnen.',
      'vl.vcap': '60-Sekunden-Vorstellung',
      'vl.pt': 'Das Problem',
      'vl.p1': 'Jedes Team verdrahtet seine eigenen Modellaufrufe \u2014 eigene Schl\u00fcssel, eigene Prompts.',
      'vl.p2': 'Niemand kann sagen, was KI wirklich kostet, bis die Rechnung eintrifft.',
      'vl.p3': 'Fragt die Rechtsabteilung, warum das Modell etwas gesagt hat, gibt es keine Antwort.',
      'vl.p4': 'Ein Anbieterwechsel bedeutet, jeden Dienst gleichzeitig umzubauen.',
      'vl.st': 'Was ich stattdessen baue',
      'vl.s1': 'Ein Gateway, durch das jeder KI-Aufruf l\u00e4uft \u2014 einf\u00fchrbar in unter einem Tag pro Team.',
      'vl.s2': 'Ausgaben je Team gedeckelt und ausgewiesen, sichtbar vor der Rechnung.',
      'vl.s3': 'Jeder Prompt, jeder Abruf und jede Antwort nachvollziehbar und wiederholbar.',
      'vl.s4': 'Der Anbieterwechsel wird zur Konfigurations\u00e4nderung statt zum Neuschreiben.',
      'vl.ctag': 'Live-Demo', 'vl.ch': 'Was w\u00fcrde Governance Ihnen sparen?',
      'vl.cd': 'Bewegen Sie die Regler. Die Werte rechnen sich beim Ziehen neu.',
      'vl.cq': 'Anfragen pro Tag', 'vl.ct': 'Durchschnittliche Tokens je Anfrage', 'vl.cteam': 'Teams mit Modellzugriff',
      'vl.cbefore': 'Ohne Governance', 'vl.cafter': '\u00dcber das Gateway',
      'vl.cmo': 'pro Monat', 'vl.csave': 'gespart',
      'vl.cnote': 'Nur zur Veranschaulichung, auf Basis ver\u00f6ffentlichter Listenpreise. Die Einsparung entsteht durch das Routen einfacher Anfragen an kleinere Modelle, das Zwischenspeichern von Wiederholungen und das K\u00fcrzen aufgebl\u00e4hter Prompts \u2014 die drei Hebel, die ein Gateway \u00fcberhaupt erst erm\u00f6glicht.',
    ...
    ms: {
      ...
      'nav.impact': 'Impak',
      'nav.ach': 'Anugerah',
      'ac.tag': 'Pengiktirafan',
      'ac.h2': 'Pencapaian &amp; <span class="grad-text">Pengiktirafan</span>',
      'ac.desc': 'Sistem yang dihantar, pasukan yang membinanya, dan detik yang bermakna.',
      'ac.first': 'Pertama di dunia',
      'ac.ft': 'Rumah penjelasan 834 berasaskan SaaS yang pertama',
      'ac.fd': 'Pendaftaran EDI 834 sentiasa melalui rumah penjelasan di premis sendiri. Kami membawanya ke SaaS \u2014 berbilang penyewa, selaras HIPAA, dan mampu menerima pembayar baharu tanpa perlu menghantar pelayan kepada sesiapa.',
      'ac.watch': 'Tonton pembentangan',
      'ac.qt': 'Di sinilah saya berhenti menjadi orang yang menulis kod dan mula menjadi orang yang menjawab \u201cmengapa begini?\u201d \u2014 piawaian seni bina, penilaian kesan, keputusan reka bentuk selaras HIPAA merentas platform penjagaan kesihatan. Bahagian teknikal boleh saya pelajari. Peralihan yang lebih sukar ialah menyedari bahawa tugas saya kini adalah menjadikan jurutera lain berkesan, bukan menjadi jurutera paling berkesan dalam bilik itu.',
      'ac.qc': 'Mengenai memimpin pasukan platform di MTBC (CareCloud), 2016\u20132018',
      'ac.g1': 'Anugerah Pasukan Inovasi Terbaik', 'ac.g2': 'MTBC (CareCloud), Islamabad',
      'ac.g3': 'CIO DHL &amp; Ketua Teknikal', 'ac.g4': 'Sidang Kepimpinan AS',
      'ac.g5': 'Latihan Keselamatan', 'ac.g6': 'Anugerah Kecemerlangan',
      'ac.cv': 'CV penuh &amp; media di LinkedIn',

      'nav.value': 'Pendekatan',
      'vl.tag': 'Apa Yang Saya Lakukan',
      'vl.h2': 'Daripada <span class="grad-text">Kekacauan AI</span> Kepada Platform Bertadbir',
      'vl.desc': 'Enam puluh saat tentang siapa saya, masalah yang sering saya diupah selesaikan, dan kalkulator yang boleh anda kendalikan sendiri.',
      'vl.vcap': 'Pengenalan 60 saat',
      'vl.pt': 'Masalahnya',
      'vl.p1': 'Setiap pasukan menyambung panggilan model sendiri, dengan kunci dan gesaan masing-masing.',
      'vl.p2': 'Tiada siapa boleh menyatakan kos sebenar AI sehingga invois tiba.',
      'vl.p3': 'Apabila pihak undang-undang bertanya mengapa model berkata begitu, tiada jawapan.',
      'vl.p4': 'Menukar pembekal model bermakna mengstruktur semula setiap perkhidmatan serentak.',
      'vl.st': 'Apa yang saya bina sebaliknya',
      'vl.s1': 'Satu get laluan yang dilalui setiap panggilan AI, boleh diguna pakai dalam kurang sehari setiap pasukan.',
      'vl.s2': 'Perbelanjaan dihadkan dan dilaporkan setiap pasukan, kelihatan sebelum invois.',
      'vl.s3': 'Setiap gesaan, perolehan dan jawapan dijejak serta boleh dimainkan semula untuk audit.',
      'vl.s4': 'Menukar pembekal menjadi perubahan konfigurasi, bukan penulisan semula.',
      'vl.ctag': 'Demo langsung', 'vl.ch': 'Berapa yang tadbir urus boleh jimatkan?',
      'vl.cd': 'Gerakkan gelangsar. Angka dikira semula sambil anda menyeret.',
      'vl.cq': 'Soalan sehari', 'vl.ct': 'Purata token setiap soalan', 'vl.cteam': 'Pasukan memanggil model',
      'vl.cbefore': 'Tanpa tadbir urus', 'vl.cafter': 'Melalui get laluan',
      'vl.cmo': 'sebulan', 'vl.csave': 'dijimatkan',
      'vl.cnote': 'Anggaran ilustrasi sahaja, menggunakan harga senarai yang diterbitkan. Penjimatan datang daripada menghalakan soalan mudah ke model lebih kecil, menyimpan cache soalan berulang dan memangkas gesaan berlebihan \u2014 tiga tuas yang hanya mungkin dengan get laluan.',
